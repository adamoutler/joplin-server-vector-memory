...
pytest tests/test_ephemeral_joplin.py tests/test_e2e_workflow.py tests/test_live_api_e2e.py server/tests/ | tee -a docs/qa/test-results.latest.txt
...
pytest tests/test_auth_flow.py | tee -a docs/qa/test-results.latest.txt

echo "Running UI Tests..." | tee -a docs/qa/test-results.latest.txt
pytest tests/test_ui_api_key.py | tee -a docs/qa/test-results.latest.txt
